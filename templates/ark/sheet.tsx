...
>(({ className, side = "right", children, ...props }, ref) => (
  <Dialog.Positioner>
    ...
    >
      {children}
      <Dialog.CloseTrigger className="absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:border-ring focus:ring-ring/50 focus:ring-[3px] disabled:pointer-events-none">
        <X className="h-4 w-4" />
